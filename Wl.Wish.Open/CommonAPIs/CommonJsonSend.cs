...
namespace Wl.Wish.Open.CommonAPIs
{
    public static class CommonJsonSend
    {
        ...
        /// <returns></returns>
        [Obsolete("建议使用Wl.Wish.CommonAPIs.CommonJsonSend.Send()方法")]
        ...
        {
            return Wl.Wish.CommonAPIs.CommonJsonSend.Send(accessToken, urlFormat, data, sendType, timeOut, checkValidationResult, jsonSetting);
        }
        ...
        {
            return Wl.Wish.CommonAPIs.CommonJsonSend.Send<T>(accessToken, urlFormat, data, sendType, timeOut, checkValidationResult, jsonSetting);
        }
